...
def main() -> int:
    ...
    align = client.get("/api/v1/food/align", params={"q": "雞胸肉", "limit": 1})
    ...
    summary = client.get("/api/v1/meals/summary", headers=headers, params={"days": 7})
    print("summary", summary.status_code)
    if summary.status_code != 200:
        print(summary.text)
        return 1

    recent = client.get("/api/v1/meals", headers=headers, params={"limit": 5})
